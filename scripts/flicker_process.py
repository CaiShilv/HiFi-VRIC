...
data_root_dir = '/media/csl/data/flicker_2W/flicker_2W_images'
train_root_dir = '/media/csl/disk_4T/invcomp_data/flicker_train'
test_root_dir = '/media/csl/disk_4T/invcomp_data/flicker_test'
